...
(function() {
  ...
  NODEJS_06 = NODEJS === true && process.version.match(/^v0\.6/);
  ...
  KissmetricsClient = (function() {
    ...
    KissmetricsClient.prototype._httpRequest = function(args) {
      var url, _ref;
    ...
    KissmetricsClient.prototype._generateQuery = function(type, data) {
      ...
      return this.lastQuery = this._httpRequest({
        host: this.host,
  ...
  AnonKissmetricsClient = (function(_super) {
    ...
    function AnonKissmetricsClient(apiKey, options) {
      ...
      if (!(person = this.storage.get(storageKey))) {
        this.storage.set(storageKey, person = this.createID());
      }
