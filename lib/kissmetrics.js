...
(function() {
  ...
  NODEJS = (typeof module !== "undefined" && module !== null ? module.exports : void 0) != null;
  ...
  KissmetricsClient = (function() {
    ...
    KissmetricsClient.batchProcess = function() {
      var batchProcessArgs, _ref;
      batchProcessArgs = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (NODEJS !== true) {
        return;
      }
      return (_ref = require('./kissmetrics-batch')).process.apply(_ref, batchProcessArgs);
    };
    ...
    KissmetricsClient.prototype.alias = function(newIdentity) {
      var instanceToReturn;
      instanceToReturn = this._generateQuery('alias', {
        _n: newIdentity
      });
      this.person = newIdentity;
  ...
  AnonKissmetricsClient = (function(_super) {
    ...
    AnonKissmetricsClient.prototype.alias = function(newIdentity, deleteStoredID) {
      ...
      return AnonKissmetricsClient.__super__.alias.call(this, newIdentity);
    };
